...
pub const div_t = struct_unnamed_4;
const struct_unnamed_5 = extern struct {
    quot: c_long,
    rem: c_long,
};
pub const ldiv_t = struct_unnamed_5;
const struct_unnamed_6 = extern struct {
    quot: c_longlong,
    rem: c_longlong,
};
pub const lldiv_t = struct_unnamed_6;
...
pub const __sigset_t = struct_unnamed_7;
...
pub const fd_set = struct_unnamed_8;
...
pub const __once_flag = struct_unnamed_13;
pub const pthread_t = c_ulong;
const union_unnamed_14 = extern union {
    __size: [4]u8,
    __align: c_int,
};
pub const pthread_mutexattr_t = union_unnamed_14;
const union_unnamed_15 = extern union {
    __size: [4]u8,
    __align: c_int,
};
pub const pthread_condattr_t = union_unnamed_15;
...
pub const pthread_mutex_t = union_unnamed_16;
const union_unnamed_17 = extern union {
    __data: struct___pthread_cond_s,
    __size: [48]u8,
    __align: c_longlong,
};
pub const pthread_cond_t = union_unnamed_17;
const union_unnamed_18 = extern union {
    __data: struct___pthread_rwlock_arch_t,
    __size: [56]u8,
    __align: c_long,
};
pub const pthread_rwlock_t = union_unnamed_18;
const union_unnamed_19 = extern union {
    __size: [8]u8,
    __align: c_long,
};
pub const pthread_rwlockattr_t = union_unnamed_19;
pub const pthread_spinlock_t = c_int;
const union_unnamed_20 = extern union {
    __size: [32]u8,
    __align: c_long,
};
pub const pthread_barrier_t = union_unnamed_20;
const union_unnamed_21 = extern union {
    __size: [4]u8,
    __align: c_int,
};
pub const pthread_barrierattr_t = union_unnamed_21;
...
pub const TSInputEncodingUTF8 = @enumToInt(enum_unnamed_22.TSInputEncodingUTF8);
pub const TSInputEncodingUTF16 = @enumToInt(enum_unnamed_22.TSInputEncodingUTF16);
pub const TSInputEncoding = enum_unnamed_22;
...
pub const TSSymbolTypeRegular = @enumToInt(enum_unnamed_23.TSSymbolTypeRegular);
pub const TSSymbolTypeAnonymous = @enumToInt(enum_unnamed_23.TSSymbolTypeAnonymous);
pub const TSSymbolTypeAuxiliary = @enumToInt(enum_unnamed_23.TSSymbolTypeAuxiliary);
pub const TSSymbolType = enum_unnamed_23;
const struct_unnamed_24 = extern struct {
    row: u32,
    column: u32,
};
pub const TSPoint = struct_unnamed_24;
...
pub const TSRange = struct_unnamed_25;
const struct_unnamed_26 = extern struct {
    payload: ?*c_void,
    read: ?fn (?*c_void, u32, TSPoint, [*c]u32) callconv(.C) [*c]const u8,
    encoding: TSInputEncoding,
};
pub const TSInput = struct_unnamed_26;
const enum_unnamed_27 = extern enum(c_int) {
    TSLogTypeParse,
    TSLogTypeLex,
    _,
};
pub const TSLogTypeParse = @enumToInt(enum_unnamed_27.TSLogTypeParse);
pub const TSLogTypeLex = @enumToInt(enum_unnamed_27.TSLogTypeLex);
pub const TSLogType = enum_unnamed_27;
const struct_unnamed_28 = extern struct {
    payload: ?*c_void,
    log: ?fn (?*c_void, TSLogType, [*c]const u8) callconv(.C) void,
};
pub const TSLogger = struct_unnamed_28;
...
pub const TSInputEdit = struct_unnamed_29;
const struct_unnamed_30 = extern struct {
    context: [4]u32,
    id: ?*const c_void,
    tree: ?*const TSTree,
};
pub const TSNode = struct_unnamed_30;
const struct_unnamed_31 = extern struct {
    tree: ?*const c_void,
    id: ?*const c_void,
    context: [2]u32,
};
pub const TSTreeCursor = struct_unnamed_31;
const struct_unnamed_32 = extern struct {
    node: TSNode,
    index: u32,
};
pub const TSQueryCapture = struct_unnamed_32;
...
pub const TSQueryMatch = struct_unnamed_33;
...
pub const TSQueryPredicateStepTypeDone = @enumToInt(enum_unnamed_34.TSQueryPredicateStepTypeDone);
pub const TSQueryPredicateStepTypeCapture = @enumToInt(enum_unnamed_34.TSQueryPredicateStepTypeCapture);
pub const TSQueryPredicateStepTypeString = @enumToInt(enum_unnamed_34.TSQueryPredicateStepTypeString);
pub const TSQueryPredicateStepType = enum_unnamed_34;
const struct_unnamed_35 = extern struct {
    type: TSQueryPredicateStepType,
    value_id: u32,
};
pub const TSQueryPredicateStep = struct_unnamed_35;
...
pub const TSQueryErrorNone = @enumToInt(enum_unnamed_36.TSQueryErrorNone);
pub const TSQueryErrorSyntax = @enumToInt(enum_unnamed_36.TSQueryErrorSyntax);
pub const TSQueryErrorNodeType = @enumToInt(enum_unnamed_36.TSQueryErrorNodeType);
pub const TSQueryErrorField = @enumToInt(enum_unnamed_36.TSQueryErrorField);
pub const TSQueryErrorCapture = @enumToInt(enum_unnamed_36.TSQueryErrorCapture);
pub const TSQueryErrorStructure = @enumToInt(enum_unnamed_36.TSQueryErrorStructure);
pub const TSQueryError = enum_unnamed_36;
...
pub extern fn ts_query_step_is_definite(self: ?*const TSQuery, byte_offset: u32) bool;
...
pub const __GLIBC_USE = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/features.h:179:9
pub const __NTH = @compileError("unable to translate C expr: unexpected token .Identifier"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:57:11
pub const __NTHNL = @compileError("unable to translate C expr: unexpected token .Identifier"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:58:11
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:105:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token .Hash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:106:9
pub const __warndecl = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:133:10
pub const __warnattr = @compileError("unable to translate C expr: unexpected token .Nl"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:134:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:135:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token .LBracket"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:143:10
pub const __REDIRECT = @compileError("unable to translate C expr: unexpected token .Hash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:174:10
pub const __REDIRECT_NTH = @compileError("unable to translate C expr: unexpected token .Hash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:181:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate C expr: unexpected token .Hash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:183:11
pub const __ASMNAME2 = @compileError("unable to translate C expr: unexpected token .Identifier"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:187:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token .Nl"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:219:10
pub const __extern_inline = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:346:11
pub const __extern_always_inline = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:347:11
pub const __attribute_copy__ = @compileError("unable to translate C expr: unexpected token .Nl"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:441:10
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token .Nl"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:512:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token .Nl"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:513:10
pub const __glibc_macro_warning1 = @compileError("unable to translate C expr: unexpected token .Hash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:527:10
pub const __attr_access = @compileError("unable to translate C expr: unexpected token .Nl"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/sys/cdefs.h:559:11
pub const __S16_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:109:9
pub const __U16_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:110:9
pub const __SLONGWORD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:113:9
pub const __ULONGWORD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:114:9
pub const __SQUAD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:128:10
pub const __UQUAD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:129:10
pub const __SWORD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:130:10
pub const __UWORD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:131:10
pub const __S64_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:134:10
pub const __U64_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_int"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:135:10
pub const __STD_TYPE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types.h:137:10
pub const __FSID_T_TYPE = @compileError("unable to translate C expr: expected Identifier instead got: LBrace"); // /home/himu/programs/zig_0.8/lib/libc/include/x86_64-linux-gnu/bits/typesizes.h:73:9
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
pub const __f32 = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:91:12
pub const __f64x = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:120:13
pub const __CFLOAT32 = @compileError("unable to translate C expr: unexpected token .Keyword_complex"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate C expr: unexpected token .Keyword_complex"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate C expr: unexpected token .Keyword_complex"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate C expr: unexpected token .Keyword_complex"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
pub const __builtin_huge_valf32 = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:218:12
pub const __builtin_inff32 = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:219:12
pub const __builtin_huge_valf64 = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_huge_valf32x = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_huge_valf64x = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const MB_CUR_MAX = @compileError("unable to translate C expr: unexpected token .RParen"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdlib.h:96:9
pub const __FD_ZERO = @compileError("unable to translate C expr: unexpected token .Keyword_do"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')'"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')'"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/select.h:34:9
pub const _SIGSET_NWORDS = @compileError("unable to translate C expr: expected ')'"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/types/__sigset_t.h:4:9
pub const __PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token .LBrace"); // /home/himu/programs/zig_0.8/lib/libc/include/x86_64-linux-gnu/bits/struct_mutex.h:56:10
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token .LBrace"); // /home/himu/programs/zig_0.8/lib/libc/include/x86_64-linux-gnu/bits/struct_rwlock.h:40:11
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token .LBrace"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/bits/thread-shared-types.h:127:9
pub const __INT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:106:11
pub const __UINT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:107:11
pub const INT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:252:11
pub const UINT32_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:260:10
pub const UINT64_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:262:11
pub const INTMAX_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:269:11
pub const UINTMAX_C = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/himu/programs/zig_0.8/lib/libc/include/generic-glibc/stdint.h:270:11
...
pub fn __FD_ISSET(d: anytype, s: anytype) callconv(.Inline) @TypeOf((__FDS_BITS(s)[__FD_ELT(d)] & __FD_MASK(d)) != 0) {
...
pub const bool_37 = bool;
pub const @"true" = 1;
pub const @"false" = 0;
pub const __bool_true_false_are_defined = 1;
pub const TREE_SITTER_LANGUAGE_VERSION = 13;
pub const TREE_SITTER_MIN_COMPATIBLE_LANGUAGE_VERSION = 13;
