...
pub const va_start = @compileError("TODO implement function '__builtin_va_start' in std.c.builtins"); // /home/himu/programs/zig-0.8.0/lib/include/stdarg.h:17:9
pub const va_end = @compileError("TODO implement function '__builtin_va_end' in std.c.builtins"); // /home/himu/programs/zig-0.8.0/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("TODO implement function '__builtin_va_arg' in std.c.builtins"); // /home/himu/programs/zig-0.8.0/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("TODO implement function '__builtin_va_copy' in std.c.builtins"); // /home/himu/programs/zig-0.8.0/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("TODO implement function '__builtin_va_copy' in std.c.builtins"); // /home/himu/programs/zig-0.8.0/lib/include/stdarg.h:27:9
...
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /home/himu/programs/zig-0.8.0/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:102:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /home/himu/programs/zig-0.8.0/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:106:9
...
pub fn __feof_unlocked_body(_fp: anytype) callconv(.Inline) @TypeOf((_fp.*._flags & _IO_EOF_SEEN) != @as(c_int, 0)) {
...
pub const _IO_USER_LOCK = @import("std").meta.promoteIntLiteral(c_int, 0x8000, .hexadecimal);
...
pub const TMP_MAX = @import("std").meta.promoteIntLiteral(c_int, 238328, .decimal);
...
pub const TREE_SITTER_LANGUAGE_VERSION = @as(c_int, 13);
